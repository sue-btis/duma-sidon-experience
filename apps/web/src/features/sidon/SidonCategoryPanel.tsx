...
export function SidonCategoryPanel({ category, content, modulesLabel, solvesLabel }: Props) {
  return <div className={styles.categoryPanel}>
    <div className={styles.categoryIdentity}><Image alt="" height={104} src="/home/worlds/sidon.png" unoptimized width={104} /><span>{content.name}</span><Image alt="" height={220} src={category.icon} unoptimized width={220} /></div>
