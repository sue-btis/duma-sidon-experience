...
const modules: Record<Locale, Record<string, () => Promise<MessageModule>>> = {
  es: {
    ...
    travesia: () => import("./messages/es/travesia.json") as unknown as Promise<MessageModule>,
  ...
  en: {
    ...
    travesia: () => import("./messages/en/travesia.json") as unknown as Promise<MessageModule>,
